...
typedef void CMilConnectionManager;
typedef PVOID HMIL_CONNECTIONMANAGER;
typedef interface IMilCommandTransport *HMIL_COMMANDTRANSPORT;
typedef void CMilCrossThreadTransport;
typedef PVOID HMIL_CROSSTHREADCOMMANDTRANSPORT;

DECLARE_MIL_HANDLE(HMIL_CONNECTION);

#define MILTYPES_DEFINED // Needed for MILEffects.idl
#define MILCORE_KERNEL_COMPONENT 0
