...
NTSTATUS NTAPI HDA_TransferCodecVerbs(
	...
	codecAddr = (UINT16)devData->CodecIds.CodecAddress;
...
NTSTATUS NTAPI HDA_SetupDmaEngineWithBdl(
   _In_ PVOID _context,
   _In_ HANDLE Handle,
...
NTSTATUS NTAPI HDA_AllocateContiguousDmaBuffer(
  _In_ PVOID _context,
  _In_ HANDLE Handle,
...
NTSTATUS NTAPI HDA_FreeContiguousDmaBuffer(
  _In_ PVOID _context,
  _In_ HANDLE Handle
) {
...
NTSTATUS NTAPI HDA_RegisterNotificationCallback(
	_In_ PVOID _context,
	_In_ HANDLE Handle,
	PDEVICE_OBJECT Fdo,
...
NTSTATUS NTAPI HDA_UnregisterNotificationCallback(
	_In_ PVOID _context,
	_In_ HANDLE Handle,
	PHDAUDIO_DMA_NOTIFICATION_CALLBACK NotificationCallback,
	PVOID CallbackContext
