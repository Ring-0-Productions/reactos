...
BEGIN_TM_CLASS_PARTS(DWMWINDOW)
    TM_PART(1, DWMWP, PART_1)
    TM_PART(2, DWMWP, PART_2)
    TM_PART(3, DWMWP, PART_3)
    TM_PART(4, DWMWP, PART_4)
    TM_PART(5, DWMWP, PART_5)
    TM_PART(6, DWMWP, PART_6)
    TM_PART(7, DWMWP, PART_7)
    TM_PART(8, DWMWP, PART_8)
    TM_PART(9, DWMWP, PART_9)
    TM_PART(10, DWMWP, PART_10)
    TM_PART(11, DWMWP, PART_11)
    TM_PART(12, DWMWP, PART_12)
    TM_PART(13, DWMWP, PART_13)
    TM_PART(14, DWMWP, PART_14)
    TM_PART(15, DWMWP, PART_15)
    TM_PART(16, DWMWP, PART_16)
    TM_PART(17, DWMWP, PART_17)
    TM_PART(18, DWMWP, PART_18)
    TM_PART(19, DWMWP, PART_19)
    TM_PART(20, DWMWP, PART_20)
    TM_PART(21, DWMWP, PART_21)
    TM_PART(22, DWMWP, PART_22)
    TM_PART(23, DWMWP, PART_23)
    TM_PART(24, DWMWP, PART_24)
    TM_PART(25, DWMWP, PART_25)
    TM_PART(26, DWMWP, PART_26)
    TM_PART(27, DWMWP, PART_27)
    TM_PART(28, DWMWP, PART_28)
    TM_PART(29, DWMWP, PART_29)
    TM_PART(30, DWMWP, PART_30)
    TM_PART(31, DWMWP, PART_31)
    TM_PART(32, DWMWP, PART_32)
    TM_PART(33, DWMWP, PART_33)
    TM_PART(34, DWMWP, PART_34)
    TM_PART(35, DWMWP, PART_35)
    TM_PART(36, DWMWP, PART_36)
    TM_PART(37, DWMWP, PART_37)
    TM_PART(38, DWMWP, PART_38)
    TM_PART(39, DWMWP, PART_39)
    TM_PART(40, DWMWP, PART_40)
    TM_PART(41, DWMWP, PART_41)
    TM_PART(42, DWMWP, PART_42)
    TM_PART(43, DWMWP, PART_43)
    TM_PART(44, DWMWP, PART_44)
    TM_PART(45, DWMWP, PART_45)
    TM_PART(46, DWMWP, PART_46)
    TM_PART(47, DWMWP, PART_47)
    TM_PART(48, DWMWP, PART_48)
    TM_PART(49, DWMWP, PART_49)
    TM_PART(50, DWMWP, PART_50)
    TM_PART(51, DWMWP, PART_51)
    TM_PART(52, DWMWP, PART_52)
    TM_PART(53, DWMWP, PART_53)
    TM_PART(54, DWMWP, PART_54)
    TM_PART(55, DWMWP, PART_55)
    TM_PART(56, DWMWP, PART_56)
    TM_PART(57, DWMWP, PART_57)
    TM_PART(58, DWMWP, PART_58)
END_TM_CLASS_PARTS()

/* DWMWINDOW states */
BEGIN_TM_PART_STATES(DWMWINDOW)
    TM_STATE(1, DWMWS, STATE_1)
    TM_STATE(2, DWMWS, STATE_2)
    TM_STATE(3, DWMWS, STATE_3)
    TM_STATE(4, DWMWS, STATE_4)
END_TM_PART_STATES()
