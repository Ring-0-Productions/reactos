...
#define IdentifyDataSerialNumberValid(IdentifyData) \
    ((IdentifyData)->SerialNumber[0] != ' ' &&  \
     (IdentifyData)->SerialNumber[0] != ANSI_NULL)

#define AtaPdoSerialNumberValid(DeviceExtension) \
...
#define REQUEST_FLAG_HAS_TASK_FILE            0x00002000
    ...
    _In_ PSCSI_REQUEST_BLOCK Srb)
{
    ...
    return Cdb->CDB10.TransferBlocksMsb << 8 | Cdb->CDB10.TransferBlocksLsb;
}
