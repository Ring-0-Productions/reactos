...
@ stdcall -stub -version=0x600+ KeRevertToUserAffinityThreadEx(long)
...
@ stdcall -stub -version=0x600+ KeSetSystemAffinityThreadEx(long)
...
@ stdcall -stub NtTraceControl(long ptr long ptr long ptr)
...
@ stdcall -stub -version=0x600+ RtlNumberOfSetBitsUlongPtr(ptr)
...
@ stdcall -stub -version=0x600+ SeAccessCheckFromState(ptr ptr ptr long long ptr ptr long ptr ptr)
...
@ stdcall -version=0x600+ SeCaptureSubjectContextEx(ptr ptr ptr)
