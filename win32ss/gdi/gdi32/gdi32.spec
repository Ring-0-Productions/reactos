...
@ stdcall -stub -version=0x600+ D3DKMTCloseAdapter(ptr)
@ stdcall -stub -version=0x600+ D3DKMTCreateAllocation(ptr)
@ stdcall -stub -version=0x600+ D3DKMTCreateContext(ptr)
@ stdcall -stub -version=0x600+ D3DKMTCreateDCFromMemory(ptr)
...
@ stdcall -stub -version=0x600+ D3DKMTDestroyDCFromMemory(ptr)
...
@ stdcall -stub -version=0x600+ D3DKMTGetPresentHistory(ptr)
@ stdcall -stub -version=0x600+ D3DKMTGetProcessSchedulingPriorityClass(ptr)
...
@ stdcall -stub -version=0x600+ D3DKMTInvalidateActiveVidPn(ptr)
@ stdcall -stub -version=0x600+ D3DKMTLock(ptr)
@ stdcall -stub -version=0x600+ D3DKMTOpenAdapterFromDeviceName(ptr)
@ stdcall -stub -version=0x600+ D3DKMTOpenAdapterFromGdiDisplayName(ptr)
@ stdcall -stub -version=0x600+ D3DKMTOpenAdapterFromHdc(ptr)
@ stdcall -stub -version=0x600+ D3DKMTOpenResource(ptr)
@ stdcall -stub -version=0x600+ D3DKMTPollDisplayChildren(ptr)
...
@ stdcall -stub -version=0x600+ D3DKMTSetProcessSchedulingPriorityClass(ptr)
