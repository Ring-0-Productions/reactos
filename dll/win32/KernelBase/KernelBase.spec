...
@ stdcall -stub -version=0x601+ InternalLcidToName()
@ stdcall -stub -version=0x601+ Internal_EnumCalendarInfo()
@ stdcall -stub -version=0x601+ Internal_EnumDateFormats()
@ stdcall -stub -version=0x601+ Internal_EnumLanguageGroupLocales()
@ stdcall -stub -version=0x601+ Internal_EnumSystemCodePages()
@ stdcall -stub -version=0x601+ Internal_EnumSystemLanguageGroups()
@ stdcall -stub -version=0x601+ Internal_EnumSystemLocales()
@ stdcall -stub -version=0x601+ Internal_EnumTimeFormats()
@ stdcall -stub -version=0x601+ Internal_EnumUILanguages()
@ stdcall -stub -version=0x601+ InvalidateTzSpecificCache()
