...
@ stdcall -version=0x600+ EmProviderRegister(ptr ptr long ptr long ptr)
...
@ stdcall -version=0x600+ KeQueryMaximumProcessorCount(long)
...
@ stdcall -version=0x600+ NtTraceControl(long ptr long ptr long ptr)
...
@ stdcall SeAccessCheckFromState(ptr ptr ptr long long ptr ptr long ptr ptr)
